...
public class MemoryPool : MonoBehaviour
{
    ...
    private int increaseCount = 5;              // 오브젝트가 부족할 때 Instanctiate()로 추가 생성되는 오브젝트 개수
    ...
    private int ActiveCount => activeCount;     // 외부에서 현재 활성화 되어 있는 오브젝트 개수 확인을 위한 프로퍼티
    ...
    // 게임에 사용 중인 모든 오브젝트를 비활성화 상태로 결정
